// Central export for all UI page modules
...
export { initAdvancedScriptsPage } from './AdvancedScripts';
export { initAdvancedDeleteHistoryPage } from './AdvancedDeleteHistory';
