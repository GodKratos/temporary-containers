  ...
  methods: {
    ...
    async exportPreferences(): Promise<void> {
      ...
      try {
        ...
        this.$root.$emit(
          'showError',
          `Exporting to file failed: ${(error as Error).toString()}`,
          { close: true }
        );
      }
    },
    ...
    async exportPreferencesSync(): Promise<void> {
      try {
        ...
        this.$root.$emit(
          'showError',
          `Exporting to Firefox Sync failed: ${(error as Error).toString()}`
        );
      }
    },
    ...
    async importPreferencesSync(): Promise<void> {
      try {
        ...
        this.$root.$emit(
          'showError',
          `Importing from Firefox Sync failed: ${(error as Error).toString()}`
        );
      }
    },
    ...
    async wipePreferencesSync(): Promise<void> {
      ...
      try {
        ...
        this.$root.$emit(
          'showError',
          `Wiping Firefox Sync failed: ${(error as Error).toString()}`
        );
      }
    },
