...
<template>
  <div id="advancedDeletesHistory" class="ui form">
    <div class="field">
      <label>"Deletes History Temporary Containers"</label>
      <div class="ui small negative message">
        <strong>Warning:</strong> Every website URL that you visit in a "Deletes
        ...
        <a
          ...
          target="_blank"
          >The related Firefox bug can be found here</a
        >.<br />
        <br />
      ...
      <div class="ui small notice message">
        ...
        Temporary Containers" because the full website URLs are different.<br />
        <br />
    ...
    >
      ...
      >
        <label
          >Automatically create "Deletes History Temporary Containers"</label
        >
        <select
      ...
      <div class="field">
        ...
        <div class="ui checkbox">
          ...
          <label
            ...
            right click on links context menu</label
          >
        </div>
      </div>
      <div class="field">
        <div id="deletesHistoryContextMenuBookmarks" class="ui checkbox">
          <input
          ...
          <label
            >Show additional "Deletes History Temporary Containers" entry in the
            right click on bookmarks context menu</label
          >
        </div>
      </div>
      <div
      ...
      >
        <label
          >Delete no longer needed "Deletes History Temporary Containers"</label
        >
        <select
      ...
      <div class="field">
        <label
          >Isolation - Ctrl/Cmd+Left Mouse Click in Temporary Containers</label
        >
        <select
